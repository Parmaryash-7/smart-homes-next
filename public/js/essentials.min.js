...
/** Angular Idle **/
!function(e,T){"use strict";T.module("ngIdle",["ngIdle.keepalive","ngIdle.idle","ngIdle.countdown","ngIdle.title","ngIdle.localStorage"]),T.module("ngIdle.keepalive",[]).provider("Keepalive",function(){var l={http:null,interval:600};this.http=function(e){if(!e)throw new Error("Argument must be a string containing a URL, or an object containing the HTTP request configuration.");T.isString(e)&&(e={url:e,method:"GET"}),e.cache=!1,l.http=e};var a=this.interval=function(e){if(e=parseInt(e),isNaN(e)||e<=0)throw new Error("Interval must be expressed in seconds and be greater than 0.");l.interval=e};this.$get=["$rootScope","$log","$interval","$http",function(n,e,t,i){var o={ping:null};function r(e){n.$broadcast("KeepaliveResponse",e.data,e.status)}function u(){n.$broadcast("Keepalive"),T.isObject(l.http)&&i(l.http).then(r).catch(r)}return{_options:function(){return l},setInterval:a,start:function(){return t.cancel(o.ping),o.ping=t(u,1e3*l.interval),o.ping},stop:function(){t.cancel(o.ping)},ping:function(){u()}}}]}),T.module("ngIdle.idle",["ngIdle.keepalive","ngIdle.localStorage"]).provider("Idle",function(){var b={idle:1200,timeout:30,autoResume:"idle",interrupt:"mousemove keydown DOMMouseScroll mousewheel mousedown touchstart touchmove scroll",windowInterrupt:null,keepalive:!0},S=this.timeout=function(e){if(!1===e)b.timeout=0;else{if(!(T.isNumber(e)&&0<=e))throw new Error("Timeout must be zero or false to disable the feature, or a positive integer (in seconds) to enable it.");b.timeout=e}};this.interrupt=function(e){b.interrupt=e},this.windowInterrupt=function(e){b.windowInterrupt=e};var y=this.idle=function(e){if(e<=0)throw new Error("Idle must be a value in seconds, greater than 0.");b.idle=e};this.autoResume=function(e){b.autoResume=!0===e?"idle":!1===e?"off":e},this.keepalive=function(e){b.keepalive=!0===e},this.$get=["$interval","$log","$rootScope","$document","Keepalive","IdleLocalStorage","$window",function(t,e,n,i,o,r,u){var l={idle:null,timeout:null,idling:!1,running:!1,countdown:null},a=(new Date).getTime();function c(){b.keepalive&&(l.running&&o.ping(),o.start())}function d(){b.keepalive&&o.stop()}function s(){l.idling=!l.idling;var e=l.idling?"IdleStart":"IdleEnd";l.idling?(n.$broadcast(e),d(),b.timeout&&(l.countdown=b.timeout,f(),l.timeout=t(f,1e3,b.timeout,!1))):(c(),n.$broadcast(e)),t.cancel(l.idle)}function f(){l.idling&&(l.countdown<=0?g():(n.$broadcast("IdleWarn",l.countdown),l.countdown--))}function g(){d(),t.cancel(l.idle),t.cancel(l.timeout),l.idling=!0,l.running=!1,l.countdown=0,n.$broadcast("IdleTimeout")}function m(e,n,t){var i=e.running();e.unwatch(),n(t),i&&e.watch()}function v(e){e?r.set("expiry",{id:a,time:e}):r.remove("expiry")}var h={_options:function(){return b},_getNow:function(){return new Date},getIdle:function(){return b.idle},getTimeout:function(){return b.timeout},setIdle:function(e){m(this,y,e)},setTimeout:function(e){m(this,S,e)},isExpired:function(){var e=function(){var e=r.get("expiry");return e&&e.time?new Date(e.time):null}();return null!==e&&e<=this._getNow()},running:function(){return l.running},idling:function(){return l.idling},watch:function(e){t.cancel(l.idle),t.cancel(l.timeout);var n=b.timeout?b.timeout:0;e||v(new Date((new Date).getTime()+1e3*(b.idle+n))),l.idling?s():l.running||c(),l.running=!0,l.idle=t(s,1e3*b.idle,0,!1)},unwatch:function(){t.cancel(l.idle),t.cancel(l.timeout),l.idling=!1,l.running=!1,v(null),d()},interrupt:function(e){l.running&&(b.timeout&&this.isExpired()?g():(function(e){n.$broadcast("IdleInterrupt",e)}(e),(e||"idle"===b.autoResume||"notIdle"===b.autoResume&&!l.idling)&&this.watch(e)))}},p={clientX:null,clientY:null,swap:function(e){var n={clientX:this.clientX,clientY:this.clientY};return this.clientX=e.clientX,this.clientY=e.clientY,n},hasMoved:function(e){var n=this.swap(e);return!(null!==this.clientX&&!e.movementX&&!e.movementY)||(n.clientX!=e.clientX||n.clientY!=e.clientY)}};if(i.find("html").on(b.interrupt,function(e){"mousemove"===e.type&&e.originalEvent&&0===e.originalEvent.movementX&&0===e.originalEvent.movementY||"mousemove"===e.type&&!p.hasMoved(e)||h.interrupt()}),b.windowInterrupt)for(var I=b.windowInterrupt.split(" "),w=function(){h.interrupt()},$=0;$<I.length;$++)u.addEventListener?(u.addEventListener(I[$],w,!1),n.$on("$destroy",function(){u.removeEventListener(I[$],w,!1)})):(u.attachEvent(I[$],w),n.$on("$destroy",function(){u.detachEvent(I[$],w)}));function E(e){if("ngIdle.expiry"===e.key&&e.newValue&&e.newValue!==e.oldValue){if(T.fromJson(e.newValue).id===a)return;h.interrupt(!0)}}return u.addEventListener?(u.addEventListener("storage",E,!1),n.$on("$destroy",function(){u.removeEventListener("storage",E,!1)})):u.attachEvent&&(u.attachEvent("onstorage",E),n.$on("$destroy",function(){u.detachEvent("onstorage",E)})),h}]}),T.module("ngIdle.countdown",["ngIdle.idle"]).directive("idleCountdown",["Idle",function(e){return{restrict:"A",scope:{value:"=idleCountdown"},link:function(t){t.value=e.getTimeout(),t.$on("IdleWarn",function(e,n){t.$evalAsync(function(){t.value=n})}),t.$on("IdleTimeout",function(){t.$evalAsync(function(){t.value=0})})}}}]),T.module("ngIdle.title",[]).provider("Title",function(){var o={enabled:!0},e=this.enabled=function(e){o.enabled=!0===e};this.$get=["$document","$interpolate",function(n,t){var i={original:null,idle:"{{minutes}}:{{seconds}} until your session times out!",timedout:"Your session has expired."};return{setEnabled:e,isEnabled:function(){return o.enabled},original:function(e){if(T.isUndefined(e))return i.original;i.original=e},store:function(e){!e&&i.original||(i.original=this.value())},value:function(e){if(T.isUndefined(e))return n[0].title;n[0].title=e},idleMessage:function(e){if(T.isUndefined(e))return i.idle;i.idle=e},timedOutMessage:function(e){if(T.isUndefined(e))return i.timedout;i.timedout=e},setAsIdle:function(e){this.store();var n={totalSeconds:e};n.minutes=Math.floor(e/60),n.seconds=function(e,n,t){return new Array(n-String(e).length+1).join(t||"0")+e}(e-60*n.minutes,2),this.value(t(this.idleMessage())(n))},setAsTimedOut:function(){this.store(),this.value(this.timedOutMessage())},restore:function(){this.original()&&this.value(this.original())}}}]}).directive("title",["Title",function(i){return{restrict:"E",link:function(e,n,t){i.isEnabled()&&!t.idleDisabled&&(i.store(!0),e.$on("IdleStart",function(){i.original(n[0].innerText)}),e.$on("IdleWarn",function(e,n){i.setAsIdle(n)}),e.$on("IdleEnd",function(){i.restore()}),e.$on("IdleTimeout",function(){i.setAsTimedOut()}))}}}]),T.module("ngIdle.localStorage",[]).service("IdleStorageAccessor",["$window",function(e){return{get:function(){return e.localStorage}}}]).service("IdleLocalStorage",["IdleStorageAccessor",function(n){function t(){var t={};this.setItem=function(e,n){t[e]=n},this.getItem=function(e){return void 0!==t[e]?t[e]:null},this.removeItem=function(e){t[e]=void 0}}var i=function(){try{var e=n.get();return e.setItem("ngIdleStorage",""),e.removeItem("ngIdleStorage"),e}catch(e){return new t}}();return{set:function(e,n){i.setItem("ngIdle."+e,T.toJson(n))},get:function(e){return T.fromJson(i.getItem("ngIdle."+e))},remove:function(e){i.removeItem("ngIdle."+e)},_wrapped:function(){return i}}}])}(window,window.angular);
