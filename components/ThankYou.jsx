...
export default function ThankYou({ pageName = "your inquiry" }) {
    return (
                        ...
                        <div className="inner-flex">
                            ...
                            <div className="section-content">
                                <p className="capitalize">
                                    We appreciate you contacting us about <span className="medium-fonts">{pageName}</span>.
                                    <br />
                                    Team {loggedUser.name} will get back to you Shortly.
                                </p>
                            </div>
