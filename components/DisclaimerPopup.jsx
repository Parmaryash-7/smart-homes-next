...
export default function DisclaimerPopup() {
   ...
   useEffect(() => {
    ...
    if (isDisclaimerOpen) {
        document.body.classList.add('no-scroll-body-d');
        nextRoot?.classList.add('no-scroll-body-d'); 
    } else {
        document.body.classList.remove('no-scroll-body-d');
        nextRoot?.classList.remove('no-scroll-body-d'); 
    }
    ...
    return (
        <>
           {isDisclaimerOpen && <div className="click-overlay-d active"></div>}
            ...
            <div className={`disclaimerPopup ${isDisclaimerOpen ? 'active' : ''}`}>
                <div className="inner-flex inner-flex-small">
                    <div className="section-title flex-row alc j-c-sb">
                        <h2 className="secondary-highlight-color">Disclaimer</h2>
                    </div>
