		...
		<div className={`header-wrapper ${isHidden ? "webmenu_hidden" : ""} ${isScrolled ? "header_change" : ""}`}>
			<div className="main-container" onClick={() => setMegaMenuActive(false)}>
				<div className="header-flex" onClick={(e) => e.stopPropagation()}>
					...
					<div className="header-links-ul" style={{ minHeight: "1.5rem", zIndex: 999 }}>
						<ul className="link-font-size hidden-xs hidden-sm">
							{categoryList.map(({ category }, index) => (
								...
								>
									...
									>
										<p className={`capitalize ${megaMenuCategory === category ? "secondary-color" : ""}`}>
											{category}
										</p>
			...
			<div className={`header_contact_dropdown ${openContactDropdown ? "active" : ""}`} onClick={(e) => e.stopPropagation()} >
			...
			{megaMenuActive && (
				<div className="megamenu-wrapper" id="megamenu-wrapper" onClick={() => setMegaMenuActive(false)}>
									...
									<Link href={`/${data.slug}`}>
										...
										<div className="megamenuText">
											<div className="section-paragraph">
												<p className="medium-fonts text-uppercase white-color">{data.project_title}</p>
											</div>
											<div className="inner-flex inner-flex-smallest">
												{data.size_price && (
													<div className="project-info-flex flex-row alc">
														<div className="project_list_icon common-icon">
															<img src="/images/icon/building.svg" alt={data.project_title} className="filterIcon" />
														</div>
												...
												{data.location && (
													<div className="project-info-flex flex-row alc">
														<div className="project_list_icon common-icon">
															<img src="/images/icon/location.svg" alt={data.project_title} className="filterIcon" />
														</div>
															...
															{data.construction.progress_percent > 0 ? (
																<div className="progress" data-percentage={data.construction.progress_percent}>
																	...
																	<div className="progress-value">
																		<p className="white-color">{data.construction.progress_percent}</p>
																	</div>
																</div>
															) : (
																<div className="iconimg">
																	<img src="/images/icon/construction.svg" className="filterIcon" alt="Construction Image" />
																</div>
															)}
														</div>
			...
			<a href="https://api.whatsapp.com/send?phone=917096961250" target="_blank" rel="noopener noreferrer">
				<div className={`whatsapp_connect  ${megaMenuActive || openContactDropdown || mobileMenuToggle ? "active" : ""} `}>
