          ...
          <div className="inner-flex hide-tab-mobile">
            ...
            <div className="">
                ...
                <div className="flex-row inner-flex-medium alc">
                  <div className="link-font-size">
                    <p className="p0">
                      ...
                      {homeDetails.name} Pvt. Ltd. CIN No. :-
                      U70200GJ2012PTC100931
                    </p>
                  </div>
                </div>
              ...
              <div className="link-font-size reecosys_footer_copyright">
                <p className="">
                  All Pictures/Images shown on this website are for illustration
          ...
          <div className="visible-tab-mobile">
            <div className="reecosys-footer-link-sections reecosys-mainfooter-section-links">
              ...
              <div className="mob-link">
                <ul
                  className="quicklinks-footer quicklinks-footer-mobile inner-flex section-content section-padding-small"
                  id="accordion"
                >
                    ...
                    <div>
                      <ul className="inner-flex inner-flex-common">
                        ...
                        {projects_category.map((category) => (
                          <li
                            className="inner-flex inner-flex-small footerAccordionBlock accordion-block"
                            key={category.category}
                          >
                            <div
                              className="section-content flex-row alc j-c-sb w100 footer_accordion_click header_accordion accordion_click"
                              ...
                              <img
                                src={
                                  openAccordions[category.category]
                                    ? '/images/icon/up-arrow.svg'
                                    : '/images/icon/down-arrow.svg'
                                }
                                style={{ width: '24px' }}
                                alt="accordion-arrow"
                        ...
                        {[
                            ...
                            links: [
                              {
                                ...
                                url: 'important-documents/'
                              },
                              {
                                text: 'https://anyror.gujarat.gov.in/',
                                url: 'https://anyror.gujarat.gov.in/',
                                external: true
                              },
                              {
                                text: 'https://dholera.gujarat.gov.in',
                                url: 'https://dholera.gujarat.gov.in',
                                external: true
                              },
                              {
                                text: 'https://www.nicdc.in/',
                                url: 'https://www.nicdc.in/',
                                external: true
                              },
                              {
                                text: 'https://www.gidb.org/',
                                url: 'https://www.gidb.org/',
                                external: true
                              }
                            ]
                          }
                          ...
                          <li
                            className="footerAccordionBlock accordion-block"
                            key={section.label}
                          >
                            <div
                              className="section-content flex-row alc j-c-sb w100 footer_accordion_click header_accordion accordion_click"
              ...
              <ul className="quicklinks-footer-copyright inner-flex inner-flex-small ">
                <li>
                  <div className="web_copyright reecosys_footer_copyright link-font-size">
                    <p className="p0 text-center">
                      {' '}
                      Copyright &copy; {year} All rights reserved ,
                      {homeDetails.name} Pvt. Ltd. <br /> CIN No. :-
                      U70200GJ2012PTC100931
                    </p>
                  </div>
                </li>
                <li>
                  <div className="link-font-size  reecosys_footer_copyright ">
                    <p className="text-center">
                      All Pictures/Images shown on this website are for
                      illustration purpose only. Actual product may vary due to
                      product enhancement
                    </p>
                  </div>
                </li>
